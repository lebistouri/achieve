...
$(document).ready(function () {
  ...
  function score_indicate() {
    ...
    let scoremoyen = sum/subject_points.length;
    $("#average_indicate").text(scoremoyen);
  ...
  function judgement() {
    ...
    $('#declaration').append(`Ton niveau ${achievement} です。${pass_or_failure} です。`);
  ...
  const supp = document.getElementById('#btn-declaration');
  supp.addEventListener("click", function(){
    $('#btn-declaration').removeChild($('#declaration').text(judgement()));
  }, false);
